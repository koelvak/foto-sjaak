<?php
	...
	class LoginClass
	{
													  ...
													  $password)
		{
			...
			$message .= "http://localhost/2013-2014/Blok2/fotosjaak/index.php?content=activation&email=".$email."&password=".$password."\r\n";
			$message .= "Met vriendelijke groet,\r\n";
			$message .= "Fotosjaak uw fotograaf";
			*/
			
			$message .= "<u><b>Geachte</b> heer/mevrouw ".$infix." ".$surname."</u><br><br>";
			$message .= "Voor u kunt inloggen moet uw account <br>";
			$message .= "activeren .<br>";
			$message .= "Klik hiervoor op de onderstaande link:<br><br>";
			$message .= "<a href='http://localhost/2013-2014/Blok2/fotosjaak/index.php?content=activation&email=".$email."&password=".$password."'>activeer</a><br><br>";
